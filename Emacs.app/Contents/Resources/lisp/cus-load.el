...
(put 'Dired-Plus 'custom-loads '(dired))
...
(put 'tramp 'custom-loads '(tramp tramp-adb tramp-cache tramp-cmds tramp-crypt tramp-gvfs tramp-rclone tramp-sh tramp-smb))
